...
def load_registries():
    ...
    return best_model_registry, metrics_registry


best_model_registry, metrics_registry = load_registries()
...
# -----------------------------
# SELECT BEST MODEL METRICS
# -----------------------------
model_metrics = metrics_df[
    metrics_df["Model"] == best_model
].iloc[0]
